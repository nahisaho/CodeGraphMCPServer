...
**Version**: 2.6
**Synced With**: design-architecture-overview.md, design-core-engine.md, design-mcp-interface.md, design-storage.md, pyproject.toml (v0.7.1)
...
├── RELEASE_NOTES.ja.md      # Japanese release notes
